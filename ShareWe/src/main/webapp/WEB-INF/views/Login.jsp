        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="goMain" class="navbar-brand"><h1 class="text-primary display-6">Share We?</h1></a>
                ...
                <form action="#">
                    <div class="row g-5 justify-content-center"  id="loginDiv">
                        <div class="col-md-12 col-lg-6 col-xl-7" align="center">
                            ...
                            <div class="form-item">
                                <input type="text" class="form-control" placeholder="아이디를 입력해주세요" id="id" style="width:60%; margin-bottom: 20px;">
                            </div>
                            <div class="form-item">
                                <input type="text" class="form-control" placeholder="비밀번호를 입력해주세요" id="pw" style="width:60%;">
                            </div>
                            <button type="button" class="btn btn-outline-success" style="width:60%; height: 50px; margin-top: 50px; color: #81c408; border-color: #81c408;" id="submitBtn">로그인</button>
                            <!-- <input type="submit" value="LogIn" 
                            style="width:60%; height: 50px; margin-top: 50px; color: #81c408; background-color: white; border-color: lightgray; box-shadow: 0px 0px 0px;"> -->
                        </div>
