...
<body>
   ...
   <div class="modal fade" id="searchModal" tabindex="-1"
	...
	<!-- Single Page Header End -->
			...
			<br>
			<br>
			<h4 class="text-center text-white display-7" style="align-content: middle; color:grey !important;">회원탈퇴가 완료되었습니다.</h4>
			<br>
			<h5 class="text-center text-white display-7" style="color: grey !important;">다음에 또 만나요.</h5>
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-7" align="center">
                             <div class="actions vertical">
								<button type="button" onclick="location.href='goMain'" 
									...
									style="width: 200px !important; display: inline-block !important;">메인페이지로 이동</button></a>
							 </div>
                        </div>
                    </div>
                </form>
